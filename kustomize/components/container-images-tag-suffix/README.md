# Add a suffix to the image tag of the v-commerce container images

You may want to add a suffix to the v-commerce container image tag to target a specific version.
The Kustomize Component inside this folder can help.

## Add a suffix to the container image tag via Kustomize

To automate the deployment of the v-commerce apps with a suffix added to the container image tag, you can leverage the following variation with [Kustomize](../..).
